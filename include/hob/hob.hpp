...
public:
    ...
    hobject & operator=(const hob & ref)
    {
    ...
    hob(const hobio::UID &id_): hobio::hobject(id_)
    {
    }
...
protected:
    ...
    virtual bool __decode(hobio::hobject &ref)
    {
        ...
        bool retval = __decode_dynamic_fields(ref);
    ...
    virtual bool __decode(hobio::decoder &is, bool update=true)
    {
        ...
        bool retval = this->hobio::hobject::__decode(is,update);
...
inline bool operator<<(hobio::encoder &e, hob &h)
{
    M_LOG("{");
...
inline bool operator>>(hobio::decoder &d, hob &h)
{
    M_LOG("{");
...
inline bool operator>>(hob            &f, hob &t)
{
    M_LOG("{");
